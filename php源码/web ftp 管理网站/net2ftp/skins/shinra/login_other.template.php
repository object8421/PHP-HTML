				...
				<ul id="sidebar">
					...
					<li>
						...
						<ul>
							...
							<li class="cat-item"><a>delete (also to  FTP server)</a></li>
							<li class="cat-item"><a>Rename and chmod (also recursive)</a></li>
							<li class="cat-item"><a>Zip and unzip files</a></li>
							<li class="cat-item"><a>Install software-the function have closed</a></li>
							<li class="cat-item"><a>Search for word-the function have closed</a></li>
